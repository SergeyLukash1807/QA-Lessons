...
public class MtsbyTest {
    ...
    private void processPaymentForServices (String phone, String amount){
        ...
        WebElement cardCvvField = driver.findElement(By.cssSelector("body > app-root > div > div > div > app-payment-container > section > div > app-card-page > div > div.card-page__card > app-card-input > form > div.card.ng-tns-c61-0 > div:nth-child(2) > div.cvc-input.ng-tns-c61-0.ng-star-inserted > app-input > div > div > div.content.ng-tns-c46-5 > label"));
        assertTrue(cardCvvField.getText().contains("CVC"));
